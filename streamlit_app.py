...
st.set_page_config(page_title="魔釣 - 岡山・下津井タイラバ予報 v1.3", page_icon="🍑")
...
st.markdown("""
    ...
    table.matsuri-table {
        ...
        color: #333;
        margin-bottom: 20px;
        background-color: #ffffff; /* 表の中は白で見やすく */
    }
    table.matsuri-table th {
        background-color: #ffe6eb; /* ヘッダーも少し濃いピンクに */
        color: #31333F;
        font-weight: bold;
        padding: 10px 4px;
        text-align: center;
    ...
    table.matsuri-table tr:nth-child(even) {
        background-color: #fffbfb; /* 縞々も極薄ピンクに */
    }
